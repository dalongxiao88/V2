...
public partial class MainWindow
{
    ...
    public MainWindow()
    {
        ...
        menuLanguageZhCN.Click += MenuLanguageZhCN_Click;
        menuLanguageEnUS.Click += MenuLanguageEnUS_Click;
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.BindCommand(ViewModel, vm => vm.StartProxyCmd, v => v.menuStartProxy).DisposeWith(disposables);
            this.BindCommand(ViewModel, vm => vm.StopProxyCmd, v => v.menuStopProxy).DisposeWith(disposables);
    ...
    private void MenuLanguageZhCN_Click(object sender, RoutedEventArgs e)
    {
        if (LanguageManager.Instance.ChangeLanguage("zh-CN"))
        {
            MainSnackbar.MessageQueue?.Enqueue("语言已切换为简体中文");
        }
    }

    private void MenuLanguageEnUS_Click(object sender, RoutedEventArgs e)
    {
        if (LanguageManager.Instance.ChangeLanguage("en-US"))
        {
            MainSnackbar.MessageQueue?.Enqueue("Language switched to English");
        }
    }
