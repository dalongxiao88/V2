...
public class MainWindowViewModel : MyReactiveObject
{
    ...
    public ReactiveCommand<Unit, Unit> StartProxyCmd { get; }
    public ReactiveCommand<Unit, Unit> StopProxyCmd { get; }
    ...
    public MainWindowViewModel(Func<EViewAction, object?, Task<bool>>? updateView)
    {
        ...
        StartProxyCmd = ReactiveCommand.CreateFromTask(async () =>
        {
            await Reload();
        });
        
        StopProxyCmd = ReactiveCommand.CreateFromTask(async () =>
        {
